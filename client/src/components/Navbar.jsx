...
import { VantixLogo } from "./ProductCard";
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center gap-6 h-16">
            ...
            <Link to="/" className="flex items-center gap-2 shrink-0">
              ...
              <span className="font-black text-xl text-gray-900 hidden sm:block tracking-tight">
                VAN<span className="text-blue-600">TIX</span>
              </span>
            </Link>
                ...
                {user ? (
                  <>
                    ...
                    >
                      ...
                      <span className="text-[10px] mt-0.5 hidden sm:block">{user.name.split(" ")[0]}</span>
                    </button>
                  ...
                  <div className="flex items-center gap-2 pl-1">
                    <Link to="/auth" className="text-sm font-semibold text-gray-700 hover:text-blue-600 transition-colors hidden sm:block whitespace-nowrap">
                      Sign in
                    </Link>
                    <Link to="/auth?mode=register" className="hidden sm:block bg-blue-600 hover:bg-blue-700 text-white text-sm font-bold px-5 py-2 rounded-full transition-colors whitespace-nowrap">
                      Create account
                    </Link>
                    <Link to="/auth" className="sm:hidden p-2 text-gray-600 hover:text-blue-600">
                      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.8} className="w-5 h-5">
          ...
          {searchOpen && (
            <div className="sm:hidden pb-3">
              <form onSubmit={handleSearch} className="flex border-2 border-blue-600 rounded-full overflow-hidden">
                <input
                  type="text"
                  value={searchVal}
                  onChange={handleSearchChange}
                  ...
                  autoFocus
                />
                <button type="submit" className="px-5 bg-blue-600 text-white flex items-center gap-1 text-sm font-semibold">
                  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2.5} className="w-4 h-4">
                    <path strokeLinecap="round" strokeLinejoin="round" d="M21 21l-5.197-5.197m0 0A7.5 7.5 0 105.196 15.803 7.5 7.5 0 0016.803 15.803z" />
                  </svg>
                  Search
